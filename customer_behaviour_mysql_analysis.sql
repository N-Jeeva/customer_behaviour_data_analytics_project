# MySQL Analysis
	This part of the project focuses on analyzing the cleaned customer data using MySQL. 
	Overall, it provides detailed insights into customer behavior that support better business decisions.
